...
\begin{evidenciabox}{Plantilla de Evidencia 1 (Dimensión D1 --- 2.00 pts)}
    ...
    \textbf{Artefacto (Ruta y Hash):} \texttt{AplicacionesDistribuidas/\allowbreak{}APORTEPARTEPRACTICA/\allowbreak{}distributed\_nodes/\allowbreak{}lamport\_clock.py} en el commit \texttt{5532cbb}\\
...
\begin{evidenciabox}{Plantilla de Evidencia 2 (Dimensión D2 --- 2.00 pts)}
    ...
    \textbf{Artefacto (Ruta y Hash):} \texttt{pe-u4-spark-Soporte-Tecnico-ISP/\allowbreak{}resultados/\allowbreak{}tiempos\_resumen.csv} y \texttt{TA-IND-04-An-lisis-de-Rendimiento-Paralelo/\allowbreak{}datos/\allowbreak{}tiempos\_base.csv} en los commits \texttt{e4406fe} y \texttt{8984eb2}\\
    \textbf{Autoría verificada:} Jeremy Alexis Alvarez Párraga (\texttt{DeJere <jalvarezp3@uteq.edu.ec>})
\end{evidenciabox}
...
\begin{evidenciabox}{Plantilla de Evidencia 3 (Dimensión D3 --- 1.50 pts)}
    ...
    \textbf{Artefacto (Ruta y Hash):} \texttt{-GA\_SUM\_03/\allowbreak{}api-gateway/\allowbreak{}nginx.conf} y \texttt{-GA\_SUM\_03/\allowbreak{}docker-compose.yml} en el commit \texttt{a91b0a8}\\
    \textbf{Autoría verificada:} Jeremy Alexis Alvarez Párraga (\texttt{DeJere <jalvarezp3@uteq.edu.ec>})
\end{evidenciabox}
...
\begin{enumerate}[label=\textbf{Pregunta \arabic*.}]
    ...
    \item \textbf{¿Cuál es la función de \texttt{props.put(\allowbreak{}ConsumerConfig.\allowbreak{}AUTO\_OFFSET\_RESET\_CONFIG,\allowbreak{} "earliest");}?}\\
    ...
    \item \textbf{¿Cuál es la implicación de configurar \texttt{ProducerConfig.\allowbreak{}VALUE\_SERIALIZER\_CLASS\_CONFIG}?}\\
